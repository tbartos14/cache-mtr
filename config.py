...
POSSIBLE_SWEEPS: Dict[str, Dict[str, Any]] = {
    "ALPHA": {"type": List[Union[int, float]], "can_be_negative": [True], "name": "alpha"},
    ...
    "NUMBER_OF_FILES_REQUESTED": {"type": List[int], "can_be_negative": [False], "name": "num_of_requests"},
    "NUMBER_OF_USERS": {"type": List[int], "can_be_negative": [False], "name": "num_users"},
}

DEFAULT_SWEEP_X: Dict = POSSIBLE_SWEEPS["ALPHA"]
DEFAULT_SWEEP_Y: Dict = POSSIBLE_SWEEPS["NUMBER_OF_USERS"]

DEFAULT_SWEEP_RANGE_X: DEFAULT_SWEEP_X["type"] = list(range(-5, 6)) if DEFAULT_SWEEP_X[
    "can_be_negative"
